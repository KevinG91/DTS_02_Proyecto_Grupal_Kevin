...
def extract_edad_from_api():
    ...
    return results_df_edad.to_csv("extracted_edad.csv")
...
def extract_edad_2_from_api():
    ...
    return results_df_edad_2.to_csv("extracted_edad_2.csv")


def transform_main():
    main_df = pd.read_csv("extracted_choques_nyc.csv")
...
def transform_robo():
    results_df_robo= pd.read_csv("extracted_robo.csv")
    ...
    return robo_sql.to_csv("robo_sql.csv")

def transform_edad():
    results_df_edad= pd.read_csv("extracted_edad.csv")
    ...
    return choques_df.to_csv("choques.csv")

def transform_edad_2():
    results_df_edad_2= pd.read_csv("extracted_edad_2.csv")
    ...
    return edad.to_csv("edad_sql.csv")


def transform_causa():
    choques_df= pd.read_csv("choques.csv")
    ...
    return causa_df.to_csv("causa_sql.csv")
...
extract_robo_from_api()
extract_edad_from_api()
extract_edad_2_from_api()
transform_main()
transform_robo()
transform_edad()
transform_edad_2()
